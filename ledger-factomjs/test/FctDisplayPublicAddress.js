...
function runTest(comm, ledger, timeout) {
	...
	comm.timeout = 5000 //allow 5 seconds to confirm
        var fct = new ledger.factom(comm);
	console.log("You have 5 seconds to confim the address on the device before bailing.")
	//All paths for the factom ledger app -MUST- be hardened.
        return fct.getAddress_async("44'/131'/0'/0'/0'", true).then(function (result) {
            console.log(result);
