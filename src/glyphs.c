...
const bagl_icon_details_t C_badge_ethereum = { GLYPH_badge_ethereum_WIDTH, GLYPH_badge_ethereum_HEIGHT, 2, C_badge_ethereum_colors, C_badge_ethereum_bitmap };
...
#ifdef OS_IO_SEPROXYHAL
#include "os_io_seproxyhal.h"
const bagl_icon_details_t C_icon_ethereum = { GLYPH_icon_ethereum_WIDTH, GLYPH_icon_ethereum_HEIGHT, 1, C_icon_ethereum_colors, C_icon_ethereum_bitmap };
#endif // OS_IO_SEPROXYHAL
#include "glyphs.h"
